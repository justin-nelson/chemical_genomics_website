<?php
     ...
     */
    $aColumns = array( 'chemical1_name', 'chemical2_name', 'score', 'IF(chemid2 IN (SELECT DISTINCT chemid FROM '.$GLOBALS["TABLE_PROCESS_TARGET_PREDICTION"].' WHERE GREATEST(dmso_FDR, rand_by_strain_FDR) < 0.25),TRUE,FALSE)');
     
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "pid";
     
    /* DB table to use */
    $sTable = $GLOBALS["TABLE_STRUCTURAL_SIMILARITY"];
