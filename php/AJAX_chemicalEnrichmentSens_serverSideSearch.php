<?php
     ...
     */
    $aColumns = array( 'chemical_multiplex', 'chemical_name', 'gene_common_name', 'lane', 'p_value', 'upload_date', 'sensitivity_type', 'pid');
     
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "pid";
     
    /* DB table to use */
    $sTable = "chemicalEnrichment";
	...
	$sWhere .= "sensitivity_type = 'sensitive' AND ";
