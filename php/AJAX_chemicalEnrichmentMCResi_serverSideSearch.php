<?php
     ...
     */
    $aColumns = array( 'chemical_multiplex', 'chemical_name', 'enrichment_type', 'id', 'lane', 'num_genes', 'num_top_genes', 'overlap_genes', 'p_uncorrected', 'pid', 'sensitivity_type', 'upload_date');
	...
	$sWhere .= "sensitivity_type = 'resistant' AND enrichment_type = 'MC' AND ";
